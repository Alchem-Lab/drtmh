...
version_format = {'rpc':'RPC', 'onesided':'onesided', 'hybrid':'hybrid'}
...
for i, version in enumerate(versions):
    ...
    plt.ylim(ymin=0.15,ymax=0.5)

#plt.legend(bbox_to_anchor=(1, 1.1), ncol=1,fontsize=20)
plt.legend(loc=3, fontsize=16, bbox_to_anchor=(-2.4, 1.15), ncol=5)
